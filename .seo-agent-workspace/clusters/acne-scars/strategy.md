# Cluster Strategy: Acne Scars

Company: MyMirror
Market: India
Cluster slug: acne-scars

## Source Metadata

- URLs considered: 96
- URLs matched: 12
- Seed keywords: tretinoin for acne scars, texture smoothing skincare routine, how to prevent acne scarring, at home vs clinical scar treatment, acne scar removal cream myth
...
| --- | --- | --- | --- | --- | --- |
| P1 | Acne Scars Category Page | product_category | startup_conversion | acne-scars | low |
| P2 | Acne Scars Guide | guide_blog | first_organic_wins | acne-scars-guide | high |
| P3 | Acne Scars Comparison Page | comparison | competitor_category | acne-scars-comparison | high |
...
- Acne Scars has enough site-inventory evidence to draft a cluster strategy before generating page packets. Evidence strength: high. Source: metadata.
...
```json
{
  ...
  "sourceMetadata": {
    ...
    "seedKeywords": [
      ...
      "texture smoothing skincare routine",
      "how to prevent acne scarring",
      "at home vs clinical scar treatment",
      "acne scar removal cream myth"
    ]
  },
  ...
  "pageOpportunities": [
    {
      "id": "P1",
      "title": "Acne Scars Category Page",
      ...
      "suggestedUrlSlug": "acne-scars",
      "evidenceStrength": "low"
    },
    {
      "id": "P2",
      "title": "Acne Scars Guide",
      "pageType": "guide_blog",
      ...
      "suggestedUrlSlug": "acne-scars-guide",
      "sourceUrl": "https://mymirror.fit/acne/skincare-layering-guide/",
      "evidenceStrength": "high"
    },
    {
      "id": "P3",
      "title": "Acne Scars Comparison Page",
      "pageType": "comparison",
      ...
      "suggestedUrlSlug": "acne-scars-comparison",
  ...
  "assumptions": [
    {
      "statement": "Acne Scars has enough site-inventory evidence to draft a cluster strategy before generating page packets.",
      "evidenceStrength": "high",
      "source": "metadata"
    },
    {
