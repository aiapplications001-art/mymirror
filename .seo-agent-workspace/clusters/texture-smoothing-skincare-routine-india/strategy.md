# Cluster Strategy: texture-smoothing-skincare-routine-india

Company: MyMirror
Market: India
Cluster slug: texture-smoothing-skincare-routine-india

## Source Metadata

- URLs considered: 96
- URLs matched: 12
- Seed keywords: texture-smoothing-skincare-routine-india
...
| guide_blog | https://mymirror.fit/ | high | URL and metadata matched the selected product/category cluster. |
| faq_support | https://mymirror.fit/acne/acne-back-cure-cheat-sheet/ | high | URL and metadata matched the selected product/category cluster. |

## Page Opportunities

| ID | Page | Type | Strategy category | Recommended slug | Evidence |
| --- | --- | --- | --- | --- | --- |
| P1 | texture-smoothing-skincare-routine-india Category Page | product_category | startup_conversion | texture-smoothing-skincare-routine-india | low |
| P2 | texture-smoothing-skincare-routine-india Guide | guide_blog | first_organic_wins | texture-smoothing-skincare-routine-india-guide | high |
| P3 | texture-smoothing-skincare-routine-india Comparison Page | comparison | competitor_category | texture-smoothing-skincare-routine-india-comparison | high |
...
- texture-smoothing-skincare-routine-india has enough site-inventory evidence to draft a cluster strategy before generating page packets. Evidence strength: high. Source: metadata.
...
```json
{
  ...
  "market": "India",
  "category": {
    "name": "texture-smoothing-skincare-routine-india",
    "slug": "texture-smoothing-skincare-routine-india"
  },
  "sourceMetadata": {
    "urlsConsidered": 96,
    "urlsMatched": 12,
    "seedKeywords": [
      "texture-smoothing-skincare-routine-india"
    ]
  },
  "existingUrlCandidates": [
    ...
    },
    {
      ...
      "pageType": "guide_blog",
      "title": "Acne Knowledge Hub: Get Expert Solutions & AI Face Analysis | MyMirror",
      "h1": "Acne Knowledge Hub",
      "evidenceStrength": "high",
      "matchReason": "URL and metadata matched the selected product/category cluster."
    },
    {
      "url": "https://mymirror.fit/acne/acne-back-cure-cheat-sheet/",
      "pageType": "faq_support",
      "title": "The Ultimate Bacne Cheat Sheet: Your Science-Backed Acne Back Cure | MyMirror",
      "h1": "The Ultimate Bacne Cheat Sheet: Your Acne Back Cure for Clear Skin",
      "evidenceStrength": "high",
      "matchReason": "URL and metadata matched the selected product/category cluster."
    }
  ],
  "pageOpportunities": [
    {
      "id": "P1",
      "title": "texture-smoothing-skincare-routine-india Category Page",
      ...
      "suggestedUrlSlug": "texture-smoothing-skincare-routine-india",
      "evidenceStrength": "low"
    },
    {
      "id": "P2",
      "title": "texture-smoothing-skincare-routine-india Guide",
      "pageType": "guide_blog",
      ...
      "suggestedUrlSlug": "texture-smoothing-skincare-routine-india-guide",
      "sourceUrl": "https://mymirror.fit/acne/skincare-layering-guide/",
      "evidenceStrength": "high"
    },
    {
      "id": "P3",
      "title": "texture-smoothing-skincare-routine-india Comparison Page",
      "pageType": "comparison",
      ...
      "suggestedUrlSlug": "texture-smoothing-skincare-routine-india-comparison",
  ...
  "assumptions": [
    {
      "statement": "texture-smoothing-skincare-routine-india has enough site-inventory evidence to draft a cluster strategy before generating page packets.",
      "evidenceStrength": "high",
      "source": "metadata"
    },
    {
