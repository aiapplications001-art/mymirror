# Pre-Writing Strategy: Stool PCR & Gut Dysbiosis: Deep Gut-Skin Axis Analysis
...
- Primary keyword: gut microbiome test for acne india
- Secondary keywords: gut dysbiosis acne breakouts, microbiome stool pcr testing, gut skin axis analysis cost, leaky gut systemic skin inflammation
...
- Selected page P9 came from cluster opportunity low_competition. Evidence strength: medium. Source: cluster_strategy.
...
```json
{
  ...
  "selectedPage": {
    "id": "P9",
    "title": "Stool PCR & Gut Dysbiosis: Deep Gut-Skin Axis Analysis",
    "pageType": "guide_blog",
    "strategyCategory": "low_competition",
    "targetIntent": "Explain how stool PCR testing and microbiome composition connect to chronic skin conditions.",
    "primaryCtaGoal": "Route readers to start MyMirror AI face scan.",
    "suggestedUrlSlug": "gut-microbiome-test-for-acne-india",
  ...
  "keywords": {
    "primary": "gut microbiome test for acne india",
    "secondary": [
      "gut dysbiosis acne breakouts",
      "microbiome stool pcr testing",
      "gut skin axis analysis cost",
      "leaky gut systemic skin inflammation"
    ],
    "clusterSeeds": [
      "acne blood test",
      "hormonal acne test",
  ...
  "evidenceNotes": [
    {
      "pointer": "Selected page P9 came from cluster opportunity low_competition.",
      "evidenceStrength": "medium",
