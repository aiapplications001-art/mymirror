# Pre-Writing Strategy: Vitamin B12 Induced Acne: The Paradoxical Trigger
...
- Primary keyword: vitamin-b12-acne-test-india
- Secondary keywords: high dose b12 acne breakouts, vitamin b12 bacterial porphyrins, b12 blood test cost india, multivitamin acne trigger
...
- Selected page P10 came from cluster opportunity low_competition. Evidence strength: medium. Source: cluster_strategy.
...
```json
{
  ...
  "selectedPage": {
    "id": "P10",
    "title": "Vitamin B12 Induced Acne: The Paradoxical Trigger",
    "pageType": "guide_blog",
    "strategyCategory": "low_competition",
    "targetIntent": "Detail how high doses of Vitamin B12 alter skin bacteria and trigger sudden acne.",
    "primaryCtaGoal": "Route readers to start MyMirror AI face scan.",
    "suggestedUrlSlug": "vitamin-b12-acne-test-india",
  ...
  "keywords": {
    "primary": "vitamin-b12-acne-test-india",
    "secondary": [
      "high dose b12 acne breakouts",
      "vitamin b12 bacterial porphyrins",
      "b12 blood test cost india",
      "multivitamin acne trigger"
    ],
    "clusterSeeds": [
      "acne blood test",
      "hormonal acne test",
  ...
  "evidenceNotes": [
    {
      "pointer": "Selected page P10 came from cluster opportunity low_competition.",
      "evidenceStrength": "medium",
