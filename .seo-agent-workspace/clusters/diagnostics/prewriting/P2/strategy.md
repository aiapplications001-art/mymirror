# Pre-Writing Strategy: Zinc Deficiency & Acne: The Sebum Regulation Marker
...
- Primary keyword: zinc test for acne india
- Secondary keywords: low zinc levels skin breakouts, zinc picolinate acne review, zinc test price india, how zinc reduces sebum biology
...
- Selected page P2 came from cluster opportunity low_competition. Evidence strength: medium. Source: cluster_strategy.
...
```json
{
  ...
  "selectedPage": {
    "id": "P2",
    "title": "Zinc Deficiency & Acne: The Sebum Regulation Marker",
    "pageType": "guide_blog",
    "strategyCategory": "low_competition",
    "targetIntent": "Explain the role of zinc in controlling skin inflammation and regulating sebaceous gland activity.",
    "primaryCtaGoal": "Route readers to start MyMirror AI face scan.",
    "suggestedUrlSlug": "zinc-test-for-acne-india",
  ...
  "keywords": {
    "primary": "zinc test for acne india",
    "secondary": [
      "low zinc levels skin breakouts",
      "zinc picolinate acne review",
      "zinc test price india",
      "how zinc reduces sebum biology"
    ],
    "clusterSeeds": [
      "acne blood test",
      "hormonal acne test",
  ...
  "evidenceNotes": [
    {
      "pointer": "Selected page P2 came from cluster opportunity low_competition.",
      "evidenceStrength": "medium",
