# Pre-Writing Strategy: Iron Deficiency & Acne: Ferritin & Serum Iron Panel
...
- Primary keyword: iron deficiency test for acne india
- Secondary keywords: ferritin levels acne scars, low iron poor skin healing, iron test cost india, anemia breakouts biology
...
- Selected page P1 came from cluster opportunity low_competition. Evidence strength: medium. Source: cluster_strategy.
...
```json
{
  ...
  "selectedPage": {
    "id": "P1",
    "title": "Iron Deficiency & Acne: Ferritin & Serum Iron Panel",
    "pageType": "guide_blog",
    "strategyCategory": "low_competition",
    "targetIntent": "Explain how iron deficiency slows down skin healing, degrades collagen synthesis, and triggers persistent breakouts.",
    "primaryCtaGoal": "Route readers to start MyMirror AI face scan.",
    "suggestedUrlSlug": "iron-deficiency-test-for-acne-india",
  ...
  "keywords": {
    "primary": "iron deficiency test for acne india",
    "secondary": [
      "ferritin levels acne scars",
      "low iron poor skin healing",
      "iron test cost india",
      "anemia breakouts biology"
    ],
    "clusterSeeds": [
      "acne blood test",
      "hormonal acne test",
  ...
  "evidenceNotes": [
    {
      "pointer": "Selected page P1 came from cluster opportunity low_competition.",
      "evidenceStrength": "medium",
