# Pre-Writing Strategy: Lipid Profile & Acne: Cholesterol & Triglyceride Analysis
...
- Primary keyword: lipid profile test for acne india
- Secondary keywords: high triglycerides clogged pores, sebum lipid composition acne, lipid profile test cost india, cholesterol barrier function skin
...
- Selected page P7 came from cluster opportunity low_competition. Evidence strength: medium. Source: cluster_strategy.
...
```json
{
  ...
  "selectedPage": {
    "id": "P7",
    "title": "Lipid Profile & Acne: Cholesterol & Triglyceride Analysis",
    "pageType": "guide_blog",
    "strategyCategory": "low_competition",
    "targetIntent": "Analyze how serum lipids and cholesterol levels impact sebum composition and follicle blockages.",
    "primaryCtaGoal": "Route readers to start MyMirror AI face scan.",
    "suggestedUrlSlug": "lipid-profile-test-for-acne-india",
  ...
  "keywords": {
    "primary": "lipid profile test for acne india",
    "secondary": [
      "high triglycerides clogged pores",
      "sebum lipid composition acne",
      "lipid profile test cost india",
      "cholesterol barrier function skin"
    ],
    "clusterSeeds": [
      "acne blood test",
      "hormonal acne test",
  ...
  "evidenceNotes": [
    {
      "pointer": "Selected page P7 came from cluster opportunity low_competition.",
      "evidenceStrength": "medium",
