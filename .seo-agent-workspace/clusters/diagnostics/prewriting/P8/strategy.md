# Pre-Writing Strategy: Progesterone-Estrogen Ratio & Acne: Premenstrual Flares
...
- Primary keyword: progesterone estrogen test for acne india
- Secondary keywords: low progesterone hormonal breakouts, estrogen dominance cystic jawline acne, hormone test cost india, luteal phase blood test
...
- Selected page P8 came from cluster opportunity low_competition. Evidence strength: medium. Source: cluster_strategy.
...
```json
{
  ...
  "selectedPage": {
    "id": "P8",
    "title": "Progesterone-Estrogen Ratio & Acne: Premenstrual Flares",
    "pageType": "guide_blog",
    "strategyCategory": "low_competition",
    "targetIntent": "Track how estrogen and progesterone ratios drive cyclical breakouts.",
    "primaryCtaGoal": "Route readers to start MyMirror AI face scan.",
    "suggestedUrlSlug": "progesterone-estrogen-test-for-acne-india",
  ...
  "keywords": {
    "primary": "progesterone estrogen test for acne india",
    "secondary": [
      "low progesterone hormonal breakouts",
      "estrogen dominance cystic jawline acne",
      "hormone test cost india",
      "luteal phase blood test"
    ],
    "clusterSeeds": [
      "acne blood test",
      "hormonal acne test",
  ...
  "evidenceNotes": [
    {
      "pointer": "Selected page P8 came from cluster opportunity low_competition.",
      "evidenceStrength": "medium",
