# Pre-Writing Strategy: Heavy Metal Toxicity & Acne: Environmental Skin Triggers
...
- Primary keyword: heavy metal test for acne india
- Secondary keywords: heavy metal toxicity acne breakouts, arsenic lead mercury skin damage, heavy metal test price india, oxidized squalene clogged pores
...
- Selected page P3 came from cluster opportunity low_competition. Evidence strength: medium. Source: cluster_strategy.
...
```json
{
  ...
  "selectedPage": {
    "id": "P3",
    "title": "Heavy Metal Toxicity & Acne: Environmental Skin Triggers",
    "pageType": "guide_blog",
    "strategyCategory": "low_competition",
    "targetIntent": "Detail how arsenic, lead, and mercury toxicity from pollution and water damages the skin barrier.",
    "primaryCtaGoal": "Route readers to start MyMirror AI face scan.",
    "suggestedUrlSlug": "heavy-metal-test-for-acne-india",
  ...
  "keywords": {
    "primary": "heavy metal test for acne india",
    "secondary": [
      "heavy metal toxicity acne breakouts",
      "arsenic lead mercury skin damage",
      "heavy metal test price india",
      "oxidized squalene clogged pores"
    ],
    "clusterSeeds": [
      "acne blood test",
      "hormonal acne test",
  ...
  "evidenceNotes": [
    {
      "pointer": "Selected page P3 came from cluster opportunity low_competition.",
      "evidenceStrength": "medium",
