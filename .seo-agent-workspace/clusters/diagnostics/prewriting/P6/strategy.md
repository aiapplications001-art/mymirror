# Pre-Writing Strategy: Liver Function & Acne: SGOT, SGPT & Detoxification Pathways
...
- Primary keyword: liver function test for acne india
- Secondary keywords: elevated sgpt sgot skin breakouts, liver detox hormone clearance, liver function test price india, sluggish liver acne connection
...
- Selected page P6 came from cluster opportunity low_competition. Evidence strength: medium. Source: cluster_strategy.
...
```json
{
  ...
  "selectedPage": {
    "id": "P6",
    "title": "Liver Function & Acne: SGOT, SGPT & Detoxification Pathways",
    "pageType": "guide_blog",
    "strategyCategory": "low_competition",
    "targetIntent": "Detail how liver health and enzyme levels affect lipid composition and acne severity.",
    "primaryCtaGoal": "Route readers to start MyMirror AI face scan.",
    "suggestedUrlSlug": "liver-function-test-for-acne-india",
  ...
  "keywords": {
    "primary": "liver function test for acne india",
    "secondary": [
      "elevated sgpt sgot skin breakouts",
      "liver detox hormone clearance",
      "liver function test price india",
      "sluggish liver acne connection"
    ],
    "clusterSeeds": [
      "acne blood test",
      "hormonal acne test",
  ...
  "evidenceNotes": [
    {
      "pointer": "Selected page P6 came from cluster opportunity low_competition.",
      "evidenceStrength": "medium",
