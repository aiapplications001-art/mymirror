# Pre-Writing Strategy: Systemic Inflammation & Acne: hs-CRP & ESR Testing
...
- Primary keyword: inflammatory markers test for acne india
- Secondary keywords: hscrp levels cystic acne breakouts, systemic inflammation swollen pimples, inflammation blood test cost india, esr range skin health
...
- Selected page P5 came from cluster opportunity low_competition. Evidence strength: medium. Source: cluster_strategy.
...
```json
{
  ...
  "selectedPage": {
    "id": "P5",
    "title": "Systemic Inflammation & Acne: hs-CRP & ESR Testing",
    "pageType": "guide_blog",
    "strategyCategory": "low_competition",
    "targetIntent": "Explain how systemic inflammatory markers correlate to painful nodulocystic acne.",
    "primaryCtaGoal": "Route readers to start MyMirror AI face scan.",
    "suggestedUrlSlug": "inflammatory-markers-test-for-acne-india",
  ...
  "keywords": {
    "primary": "inflammatory markers test for acne india",
    "secondary": [
      "hscrp levels cystic acne breakouts",
      "systemic inflammation swollen pimples",
      "inflammation blood test cost india",
      "esr range skin health"
    ],
    "clusterSeeds": [
      "acne blood test",
      "hormonal acne test",
  ...
  "evidenceNotes": [
    {
      "pointer": "Selected page P5 came from cluster opportunity low_competition.",
      "evidenceStrength": "medium",
