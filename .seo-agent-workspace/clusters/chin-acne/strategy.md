# Cluster Strategy: Chin Acne

Company: MyMirror
Market: India
Cluster slug: chin-acne

## Source Metadata

- URLs considered: 96
- URLs matched: 12
- Seed keywords: chin acne, chin acne meaning, pimples on chin
...
| --- | --- | --- | --- | --- | --- |
| P1 | Chin Acne Category Page | product_category | startup_conversion | chin-acne | low |
| P2 | Chin Acne Guide | guide_blog | first_organic_wins | chin-acne-guide | high |
| P3 | Chin Acne Comparison Page | comparison | competitor_category | chin-acne-comparison | high |
...
- Chin Acne has enough site-inventory evidence to draft a cluster strategy before generating page packets. Evidence strength: high. Source: metadata.
...
```json
{
  ...
  "pageOpportunities": [
    {
      ...
      "suggestedUrlSlug": "chin-acne",
      "evidenceStrength": "low"
    },
    {
      "id": "P2",
      "title": "Chin Acne Guide",
      "pageType": "guide_blog",
      ...
      "suggestedUrlSlug": "chin-acne-guide",
      "sourceUrl": "https://mymirror.fit/acne/skincare-layering-guide/",
      "evidenceStrength": "high"
    },
    {
      "id": "P3",
      "title": "Chin Acne Comparison Page",
      "pageType": "comparison",
      ...
      "suggestedUrlSlug": "chin-acne-comparison",
  ...
  "assumptions": [
    {
      "statement": "Chin Acne has enough site-inventory evidence to draft a cluster strategy before generating page packets.",
      "evidenceStrength": "high",
      "source": "metadata"
    },
    {
