# Cluster Strategy: best-facewash-fungal-acne

Company: MyMirror
Market: India
Cluster slug: best-facewash-fungal-acne

## Source Metadata

- URLs considered: 96
- URLs matched: 12
- Seed keywords: best facewash for fungal acne india, ketoconazole 2% face wash india, malassezia safe cleansers india
...
| --- | --- | --- | --- | --- | --- |
| P1 | best-facewash-fungal-acne Category Page | product_category | startup_conversion | best-facewash-fungal-acne | low |
| P2 | best-facewash-fungal-acne Guide | guide_blog | first_organic_wins | best-facewash-fungal-acne-guide | high |
| P3 | best-facewash-fungal-acne Comparison Page | comparison | competitor_category | best-facewash-fungal-acne-comparison | high |
...
- best-facewash-fungal-acne has enough site-inventory evidence to draft a cluster strategy before generating page packets. Evidence strength: high. Source: metadata.
...
```json
{
  ...
  "sourceMetadata": {
    ...
    "urlsMatched": 12,
    "seedKeywords": [
      "best facewash for fungal acne india",
      "ketoconazole 2% face wash india",
      "malassezia safe cleansers india"
    ]
  },
  ...
  "pageOpportunities": [
    {
      "id": "P1",
      "title": "best-facewash-fungal-acne Category Page",
      ...
      "suggestedUrlSlug": "best-facewash-fungal-acne",
      "evidenceStrength": "low"
    },
    {
      "id": "P2",
      "title": "best-facewash-fungal-acne Guide",
      "pageType": "guide_blog",
      ...
      "suggestedUrlSlug": "best-facewash-fungal-acne-guide",
      "sourceUrl": "https://mymirror.fit/acne/skincare-layering-guide/",
      "evidenceStrength": "high"
    },
    {
      "id": "P3",
      "title": "best-facewash-fungal-acne Comparison Page",
      "pageType": "comparison",
      ...
      "suggestedUrlSlug": "best-facewash-fungal-acne-comparison",
  ...
  "assumptions": [
    {
      "statement": "best-facewash-fungal-acne has enough site-inventory evidence to draft a cluster strategy before generating page packets.",
      "evidenceStrength": "high",
      "source": "metadata"
    },
    {
