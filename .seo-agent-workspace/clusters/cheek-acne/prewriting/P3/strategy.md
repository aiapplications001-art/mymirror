# Pre-Writing Strategy: Cheek Acne Comparison Page
...
- Audience cohort: Young Indian commuters and students comparing options for cheek breakouts.
- Tone selected: balanced evaluator
- Tone options: balanced evaluator, professional compact, decision-supportive
...
- Content depth target: 1200-1800 words
- Strict range: no

## CTA Strategy

- Primary CTA goal: Route high-intent comparison traffic to the best internal product/category destination.
- Recommended destination: https://mymirror.fit/acne/best-salicylic-acid-products-india/
...
Inference signals: pageType=comparison
...
- Selected page P3 came from cluster opportunity competitor_category. Evidence strength: high. Source: cluster_strategy.
- Audience cohort supplied: Young Indian commuters and students comparing options for cheek breakouts.. Evidence strength: high. Source: user_input.
...
```json
{
  ...
  "selectedPage": {
    "id": "P3",
    "title": "Cheek Acne Comparison Page",
    "pageType": "comparison",
    ...
    "suggestedUrlSlug": "cheek-acne-comparison",
    "sourceUrl": "https://mymirror.fit/acne/best-salicylic-acid-products-india/",
    "evidenceStrength": "high"
  },
  "audience": {
    "cohort": "Young Indian commuters and students comparing options for cheek breakouts.",
    "market": "India"
  },
  "tone": {
    "selected": "balanced evaluator",
  ...
  "contentDepth": {
    "targetRange": "1200-1800 words",
    "strict": false
  },
  "cta": {
    "primaryGoal": "Route high-intent comparison traffic to the best internal product/category destination.",
    "recommendedDestination": "https://mymirror.fit/acne/best-salicylic-acid-products-india/",
  ...
  "evidenceNotes": [
    {
      "pointer": "Selected page P3 came from cluster opportunity competitor_category.",
      "evidenceStrength": "high",
      "source": "cluster_strategy"
    },
    {
      "pointer": "Audience cohort supplied: Young Indian commuters and students comparing options for cheek breakouts..",
      "evidenceStrength": "high",
      "source": "user_input"
    },
    {
