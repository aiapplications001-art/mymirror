# Pre-Writing Strategy: Back Acne Scars & Marks: Fading Body Dark Spots (PIH)
...
- Primary keyword: back acne scars treatment india
- Secondary keywords: fade bacne scars fast, body hyperpigmentation cream, chemical peel for back marks, glycolic acid body spray
...
```json
{
  ...
  "selectedPage": {
    "id": "P3",
    "title": "Back Acne Scars & Marks: Fading Body Dark Spots (PIH)",
    "pageType": "guide_blog",
    "strategyCategory": "low_competition",
    "targetIntent": "Provide guidance on fading post-acne dark marks (PIH) on thick body skin using exfoliating sprays and creams.",
    "primaryCtaGoal": "Route readers to start MyMirror AI face scan.",
    "suggestedUrlSlug": "back-acne-scars-treatment-india",
  ...
  "keywords": {
    "primary": "back acne scars treatment india",
    "secondary": [
      "fade bacne scars fast",
      "body hyperpigmentation cream",
      "chemical peel for back marks",
