# Pre-Writing Strategy: Salicylic Acid Body Lotions: Clearing Rough & Bumpy Skin
...
- Primary keyword: acne body lotion salicylic acid india
- Secondary keywords: best salicylic acid lotion, strawberry legs treatment, body keratosis pilaris cream, rough bumpy skin lotion
- Cluster seed keywords: None
...
```json
{
  ...
  "selectedPage": {
    "id": "P4",
    "title": "Salicylic Acid Body Lotions: Clearing Rough & Bumpy Skin",
    "pageType": "guide_blog",
    "strategyCategory": "low_competition",
    "targetIntent": "Explain the role of BHA body lotions in hydrating and exfoliating rough, bumpy body skin to prevent breakouts.",
    "primaryCtaGoal": "Route readers to start MyMirror AI face scan.",
    "suggestedUrlSlug": "acne-body-lotion-salicylic-acid-india",
  ...
  "keywords": {
    "primary": "acne body lotion salicylic acid india",
    "secondary": [
      "best salicylic acid lotion",
      "strawberry legs treatment",
      "body keratosis pilaris cream",
      "rough bumpy skin lotion"
    ],
    "clusterSeeds": []
  },
  "contentDepth": {
