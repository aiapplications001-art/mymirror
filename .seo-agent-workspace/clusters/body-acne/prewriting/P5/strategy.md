# Pre-Writing Strategy: Post-Workout Acne Prevention: The Complete Gym Shower Protocol
...
- Primary keyword: post workout acne prevention india
- Secondary keywords: gym breakouts back chest, post gym skin care routine, best sweat acne wash, shower timeline for gym bumps
...
```json
{
  ...
  "selectedPage": {
    "id": "P5",
    "title": "Post-Workout Acne Prevention: The Complete Gym Shower Protocol",
    "pageType": "guide_blog",
    "strategyCategory": "low_competition",
    "targetIntent": "Detail sweat/gym breakouts prevention protocol to stop Malassezia and bacterial folliculitis.",
    "primaryCtaGoal": "Route readers to start MyMirror AI face scan.",
    "suggestedUrlSlug": "post-workout-acne-prevention-india",
  ...
  "keywords": {
    "primary": "post workout acne prevention india",
    "secondary": [
      "gym breakouts back chest",
      "post gym skin care routine",
      "best sweat acne wash",
      "shower timeline for gym bumps"
    ],
    "clusterSeeds": []
  },
  "contentDepth": {
