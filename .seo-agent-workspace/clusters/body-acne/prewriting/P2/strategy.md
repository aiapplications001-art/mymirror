# Pre-Writing Strategy: Butt Acne & Folliculitis Cures: Clearing buttocks pimples
...
- Primary keyword: butt acne treatment india
- Secondary keywords: butt pimples home remedies, buttocks folliculitis wash, buttocks acne dermatologist india, smooth body skin
...
```json
{
  ...
  "selectedPage": {
    "id": "P2",
    "title": "Butt Acne & Folliculitis Cures: Clearing buttocks pimples",
    "pageType": "guide_blog",
    "strategyCategory": "low_competition",
    "targetIntent": "Explain buttocks bumps/folliculitis causes such as sweat friction and tight clothing, and provide clinical remedies.",
    "primaryCtaGoal": "Route readers to start MyMirror AI face scan.",
    "suggestedUrlSlug": "butt-acne-treatment-india",
  ...
  "keywords": {
    "primary": "butt acne treatment india",
    "secondary": [
      "butt pimples home remedies",
      "buttocks folliculitis wash",
      "buttocks acne dermatologist india",
      "smooth body skin"
    ],
    "clusterSeeds": []
  },
