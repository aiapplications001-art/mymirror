# Cluster Strategy: acne-treatment

Company: MyMirror
Market: India
Cluster slug: acne-treatment

## Source Metadata

- URLs considered: 96
- URLs matched: 12
- Seed keywords: azelaic acid vs salicylic acid for acne india, spearmint tea for hormonal acne india, retinol purging timeline india, best facewash for fungal acne india, pimple marks removal cream india
...
| --- | --- | --- | --- | --- | --- |
| P1 | acne-treatment Category Page | product_category | startup_conversion | acne-treatment | low |
| P2 | acne-treatment Guide | guide_blog | first_organic_wins | acne-treatment-guide | high |
| P3 | acne-treatment Comparison Page | comparison | competitor_category | acne-treatment-comparison | high |
...
- acne-treatment has enough site-inventory evidence to draft a cluster strategy before generating page packets. Evidence strength: high. Source: metadata.
...
```json
{
  ...
  "pageOpportunities": [
    ...
    },
    {
      ...
      "suggestedUrlSlug": "acne-treatment-guide",
  ...
  "assumptions": [
    {
      "statement": "acne-treatment has enough site-inventory evidence to draft a cluster strategy before generating page packets.",
      "evidenceStrength": "high",
      "source": "metadata"
    },
    {
