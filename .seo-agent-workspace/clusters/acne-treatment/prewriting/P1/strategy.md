# Pre-Writing Strategy: acne-treatment Category Page

Company: MyMirror
Market: India
Cluster: acne-treatment
Selected page: P1

## Audience And Tone

- Audience cohort: IndianSkinCareSeekers
...
- Cluster seed keywords: azelaic acid vs salicylic acid for acne india, spearmint tea for hormonal acne india, retinol purging timeline india, best facewash for fungal acne india, pimple marks removal cream india
...
- Audience cohort supplied: IndianSkinCareSeekers. Evidence strength: high. Source: user_input.
...
```json
{
  ...
  "evidenceNotes": [
    ...
    {
      "pointer": "Audience cohort supplied: IndianSkinCareSeekers.",
