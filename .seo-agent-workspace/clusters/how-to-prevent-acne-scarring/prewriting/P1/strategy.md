# Pre-Writing Strategy: how-to-prevent-acne-scarring Category Page

Company: MyMirror
Market: India
Cluster: how-to-prevent-acne-scarring
Selected page: P1

## Audience And Tone

- Audience cohort: Indian teenagers and parents managing acne-prone skin habits.
...
- Cluster seed keywords: how-to-prevent-acne-scarring
...
Intent pattern: how_to
Structure variant: step_by_step_guide
Inference confidence: medium
Inference signals: how-to language
Inference notes: How-to intent needs ordered steps, mistakes, and expected outcome guidance.

| Section ID | Role | Section Intent | Evidence Budget (facts/cited claims/examples) | Required Devices | Notes |
| --- | --- | --- | --- | --- | --- |
| S1_hero | conversion | first-fold promise | 2/0/1 | H1, primary CTA, CTA microcopy | State the outcome, safety boundary, and primary CTA in the first fold. Primary actionable must be visible in the first fold on desktop and mobile. |
| S2_quick_answer | seo | direct answer | 3/1/1 | short answer block | Summarize the process and expected result before the full steps. |
| S3_prerequisites_safety | trust | prerequisites and safety | 4/2/1 | before-you-start checklist, not-right-for-you guidance | Do not give step advice without safety and escalation context. |
| S4_step_by_step_process | seo | step-by-step process | 6/2/3 | numbered steps, timing/routine table | Each step must include action, rationale, and practical detail. |
| S5_mistakes_troubleshooting | ux | mistake and troubleshooting guidance | 4/2/2 | mistakes table, troubleshooting flow | Use observed audience pain points where available. |
| S6_expected_outcome | conversion | expected outcome and next step | 3/1/2 | timeline, next-step checklist | Avoid guaranteed outcomes; keep timelines evidence-backed. |
...
- Audience cohort supplied: Indian teenagers and parents managing acne-prone skin habits.. Evidence strength: high. Source: user_input.
...
```json
{
  ...
  "selectedPage": {
    "id": "P1",
    "title": "how-to-prevent-acne-scarring Category Page",
    ...
    "suggestedUrlSlug": "how-to-prevent-acne-scarring",
    "evidenceStrength": "low"
  },
  "audience": {
    "cohort": "Indian teenagers and parents managing acne-prone skin habits.",
    "market": "India"
  },
  "tone": {
  ...
  "pageStructure": {
    "intentPattern": "how_to",
    "structureVariant": "step_by_step_guide",
    "inference": {
      "confidence": "medium",
      "signals": [
        "how-to language"
      ],
      "notes": "How-to intent needs ordered steps, mistakes, and expected outcome guidance."
    },
    "researchBasis": [
    ...
    "sections": [
      {
        ...
        "notes": "State the outcome, safety boundary, and primary CTA in the first fold. Primary actionable must be visible in the first fold on desktop and mobile."
      },
      {
        "id": "S2_quick_answer",
        ...
        "notes": "Summarize the process and expected result before the full steps."
      },
      {
        "id": "S3_prerequisites_safety",
        "purpose": "Explain prerequisites, safety constraints, and when not to proceed.",
        "contentRole": "trust",
        "sectionIntent": "prerequisites and safety",
        "evidenceNeeded": [
          "prerequisite",
          "safety caveat",
          "when to escalate"
        ...
        "notes": "Do not give step advice without safety and escalation context."
      },
      {
        "id": "S4_step_by_step_process",
        "purpose": "Provide the ordered process a reader can follow.",
        "contentRole": "seo",
        "sectionIntent": "step-by-step process",
        "evidenceNeeded": [
          "step",
          "why it matters",
          "example"
        ...
        "notes": "Each step must include action, rationale, and practical detail."
      },
      {
        "id": "S5_mistakes_troubleshooting",
        "purpose": "Cover common mistakes and troubleshooting paths.",
        "contentRole": "ux",
        "sectionIntent": "mistake and troubleshooting guidance",
        "evidenceNeeded": [
          "mistake",
          "symptom",
          "fix"
        ...
        "notes": "Use observed audience pain points where available."
      },
      {
        "id": "S6_expected_outcome",
        "purpose": "Set expectations for results, timelines, and next action.",
        "contentRole": "conversion",
        "sectionIntent": "expected outcome and next step",
        "evidenceNeeded": [
          "expected outcome",
          "timeframe",
          "CTA rationale"
        ...
        "notes": "Avoid guaranteed outcomes; keep timelines evidence-backed."
      },
      {
        "id": "S7_trust_proof",
  ...
  "evidenceNotes": [
    ...
    {
      "pointer": "Audience cohort supplied: Indian teenagers and parents managing acne-prone skin habits..",
