...
const pages = [
  {
    ...
    safeSteps: [
      ['Cleanse face with a gentle pH-balanced wash', 'Wash skin gently with lukewarm water and a non-stripping cleanser. Pat dry.'],
  ...
  },
  {
    ...
    decisionIntro: 'This decision guide explains how Clindamycin gel 1% works on inflammatory acne, why topical antibiotic monotherapy causes bacterial resistance, how to pair Clindamycin safely with Benzoyl Peroxide or Adapalene on Indian skin phototypes IV–VI, and when to seek dermatologist evaluation.',
    decisionCards: [
    ...
    safeIntro: 'Follow this medical safety structure to apply Clindamycin gel effectively while preventing bacterial resistance and skin irritation.',
    safeSteps: [
    ...
    faqs: [
      ...
      ['Can I buy Clindamycin gel over the counter in India?', 'No. Clindamycin is a prescription prescription medicine that should be used under dermatological guidance.'],
...
const productDetails = {
  ACR11: {
    ...
    landscape: 'In India, Niacinamide serums (such as Minimalist 5% Niacinamide, The Derma Co 10% Niacinamide, and Plum 10% Niacinamide) are top-selling active treatments. Selecting 5% prevents barrier flushing while fading spots.',
